...
enum BookingCalendarPickerType {
  ...
  ///
  /// See also [BookingCalendarPickerConfig.rangeBidirectional].
  range,
}

/// Custom enum for a date picker mode including day, month, and year.
enum BookingCalendarPickerMode {
  /// Choosing a day.
  day,
...
@Deprecated(
  'This will be removed soon. Use bookingAvailabilities from  BookingCalendarPicker',
)
...
/// Custom configuration for BookingCalendarPicker
class BookingCalendarPickerConfig {
  BookingCalendarPickerConfig({
    BookingCalendarPickerType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
    DateTime? currentDate,
    BookingCalendarPickerMode? calendarViewMode,
    this.weekdayLabels,
    ...
    this.dynamicCalendarRows,
        ...
        calendarViewMode = calendarViewMode ?? BookingCalendarPickerMode.scroll;

  /// The enabled date picker mode
  final BookingCalendarPickerType calendarType;
  ...
  final BookingCalendarPickerMode calendarViewMode;
  ...
  /// Only applicable when [calendarType] is [BookingCalendarPickerType.range]
  final Color? selectedRangeHighlightColor;

  /// Custom text style for disabled calendar day(s)
  final TextStyle? disabledDayTextStyle;

  /// Custom text style for checkout only calendar day(s)
  final TextStyle? checkoutOnlyDayTextStyle;
  ...
  /// Copy the current [BookingCalendarPickerConfig] with some new values
  BookingCalendarPickerConfig copyWith({
    BookingCalendarPickerType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
    DateTime? currentDate,
    ...
    TextStyle? checkoutOnlyDayTextStyle,
    ...
    return BookingCalendarPickerConfig(
      ...
      checkoutOnlyDayTextStyle:
          checkoutOnlyDayTextStyle ?? this.checkoutOnlyDayTextStyle,
...
/// Custom configuration for BookingCalendarPicker with action buttons
class BookingCalendarPickerWithActionButtonsConfig
    extends BookingCalendarPickerConfig {
  BookingCalendarPickerWithActionButtonsConfig({
    BookingCalendarPickerType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
    DateTime? currentDate,
    ...
    this.buttonPadding,
          ...
          checkoutOnlyDayTextStyle: checkoutOnlyDayTextStyle,
  ...
  @override
  BookingCalendarPickerWithActionButtonsConfig copyWith({
    BookingCalendarPickerType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
    DateTime? currentDate,
    ...
    return BookingCalendarPickerWithActionButtonsConfig(
      calendarType: calendarType ?? this.calendarType,
      firstDate: DateUtils.dateOnly(firstDate ?? this.firstDate),
      lastDate: DateUtils.dateOnly(lastDate ?? this.lastDate),
      currentDate: currentDate ?? this.currentDate,
