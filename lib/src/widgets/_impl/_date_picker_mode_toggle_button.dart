...
/// A button that used to toggle the [BookingCalendarPickerMode] for a date picker.
///
/// This appears above the calendar grid and allows the user to toggle the
/// [BookingCalendarPickerMode] to display either the calendar view or the year list.
class _DatePickerModeToggleButton extends StatefulWidget {
  ...
  final BookingCalendarPickerMode mode;
...
class _DatePickerModeToggleButtonState
  ...
  void initState() {
    super.initState();
    final isMonthOrYearMode = widget.mode == BookingCalendarPickerMode.year ||
        widget.mode == BookingCalendarPickerMode.month;
  ...
  void didUpdateWidget(_DatePickerModeToggleButton oldWidget) {
    ...
    if (widget.mode == BookingCalendarPickerMode.month) {
      _monthController.forward();
      _yearController.reverse();
    }

    if (widget.mode == BookingCalendarPickerMode.year) {
      _yearController.forward();
      _monthController.reverse();
    }

    if (widget.mode == BookingCalendarPickerMode.day) {
      _yearController.reverse();
      _monthController.reverse();
    }
  }
