...
//     return MaterialApp(
//       title: 'BookingCalendarPicker Demo',
//       theme: ThemeData(
...
//         Locale('hi', ''),
//       ],
//       home: const MyHomePage(title: 'BookingCalendarPicker Demo'),
//     );
//   }
// }
...
//     BookingCalendarPickerType datePickerType,
...
//     if (datePickerType == BookingCalendarPickerType.multi) {
//       valueText = values.isNotEmpty
//           ? values
//               .map((v) => v.toString().replaceAll('00:00:00.000', ''))
//               .join(', ')
//           : 'null';
//     } else if (datePickerType == BookingCalendarPickerType.range) {
...
//     );
//     final config = BookingCalendarPickerWithActionButtonsConfig(
//       calendarViewScrollPhysics: const NeverScrollableScrollPhysics(),
//       dayTextStyle: dayTextStyle,
//       calendarType: BookingCalendarPickerType.range,
...
//             ElevatedButton(
//               onPressed: () async {
//                 // final values = await showBookingCalendarPickerDialog(
//                 //   context: context,
//                 //   config: config,
...
//       dayTextStyle: dayTextStyle,
//       calendarType: BookingCalendarPickerType.range,
//       calendarViewMode: BookingCalendarPickerMode.scroll,
...
//     final config = BookingCalendarPickerConfig(
...
//       calendarType: BookingCalendarPickerType.multi,
